...
import {
  ...
  periodTrackerResultExistenceAPI,
...
function PeriodTracker() {
  ...
  const checkExistence = async () => {
    const checkExistenceOfUser = await periodTrackerResultExistenceAPI();
    setIsExists(checkExistenceOfUser);
  };
  ...
  return isExists ? (
    // <Loader />
    <PeriodTrackerResult></PeriodTrackerResult>
  ) : (
    <Fragment>
                      ...
                      <div>
                        {" "}
                        {
                          ...
                          blurOnSelect
                            ...
                            defaultValue={question?.selected_option}
