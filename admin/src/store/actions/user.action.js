import { FETCH_USER_BEGIN, FETCH_USER_SUCCESS, FETCH_USER_FAILURE, FETCH_SP_PROFILE_BEGIN, FETCH_SP_PROFILE_FAILURE, FETCH_SP_PROFILE_SUCCESS, SAVE_SP_PROFILE_BEGIN, SAVE_SP_PROFILE_SUCCESS, SAVE_SP_PROFILE_FAILURE, FETCH_ADMIN_PROFILE_BEGIN, FETCH_ADMIN_PROFILE_SUCCESS, FETCH_ADMIN_PROFILE_FAILURE } from "../actionTypes";
...
export const fetchAdminProfileBegin = () => ({
  type: FETCH_ADMIN_PROFILE_BEGIN
});

export const fetchAdminProfileSuccess = profile => ({
...
export const fetchAdminProfileFailure = error => ({
